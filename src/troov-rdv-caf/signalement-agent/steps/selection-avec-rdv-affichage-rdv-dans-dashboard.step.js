...
Given("Un ticket associé a ce rendez-vous a été créer et la page de confirmation est ouverte", async function() {
	...
	this.ticket = await this.backofficePage.locator('text="Numéro à communiquer à l’usager"').locator('xpath=/following-sibling::div[1]/p').textContent();
	...
	console.log('==> Ticket created: ' + this.ticket + ' with motif: ' + this.motif);
...
After(async function () {
    ...
    // Localiser le ticket dans la section "Attente avec RDV"
