...
Then("Les informations affichées doivent correspondre à la prise initiale puis à l'annulation du rendez-vous", async function() {
    ...
    const deletionDetailLocator = this.backofficePage.locator('#reservation-edit-modal___BV_modal_body_ .tab-content .active ul > li').nth(1); // Adapter l'index si nécessaire
