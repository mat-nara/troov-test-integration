...
#        Then La page "Indiquez les informations concernant votre lieu" s'affiche
#
#    Scenario: Modifier les informations du lieu, puis les restaurer
#        Given La page "Indiquez les informations concernant votre lieu" est ouverte
#        When L'utilisateur modifie les champs disponibles et clique sur "Sauvegarder les changements"
#           * Il réouvre la page "Indiquez les informations concernant votre lieu"
...
#         When L'utilisateur sélectionne le compte principal "Equipe 2" et clique sur "Sauvegarder"
...
#         Then Le compte principal sélectionné précédemment "Equipe 2" est utilisé par défaut
#         Given L'utilisateur est sur la page "Paramètres" et le menu "Mon compte" est ouverte
#         When Il clique sur "Modifier votre compte principal"
#         When L'utilisateur sélectionne le compte principal "Equipe 1" et clique sur "Sauvegarder"
#         Then Un message de confirmation du changement du compte principal s'affiche
# 
# 
# 
